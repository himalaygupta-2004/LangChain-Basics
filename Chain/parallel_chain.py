...
model1 = ChatGoogleGenerativeAI(model="gemini-2.0-flash", google_api_key=api_key)
model2 = ChatGoogleGenerativeAI(model="gemini-2.0-flash", google_api_key=api_key)
# model3 = ChatGoogleGenerativeAI(model="gemini-2.0-flash", google_api_key=api_key)
